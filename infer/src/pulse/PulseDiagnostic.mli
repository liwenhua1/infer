...
type cast_err = {calling_context: calling_context; class_name: Typ.Name.t; target_class:Typ.Name.t; allocation_trace: Trace.t; location: Location.t;num_instance:int;apply_before:bool;private_or_report:bool;abs_var:PulseAbstractValue.t;is_equal:bool}
    [@@deriving compare, equal, yojson_of]
