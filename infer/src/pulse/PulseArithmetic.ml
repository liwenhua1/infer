  ...
  let helper var = (match AbductiveDomain.Summary.get_static_type var summary with 
                        ...
                        |Some (sty:Typ.name
                                      ...
                                      |Some dty -> 
                                        ...
                                        if  (PatternMatch.is_subtype tenv dty sty && PatternMatch.is_subtype tenv sty dty) || PatternMatch.is_direct_abstract_super_no_sbl  sty dty tenv || PatternMatch.is_direct_abstract_super  sty dty tenv 
